          ...
          <form method="POST" action="?/simulatePayment" class="space-y-6">
            ...
            {#if selectedPaymentMethod}
              ...
              <div class="text-right">
                <button type="submit" class="bg-[#102C57] text-white text-xl py-4 px-8 rounded-full hover:bg-[#1a3d7c] transition duration-300 ease-in-out transform hover:scale-105 shadow-lg">
                  ชำระเงิน
                </button>
              </div>
            {/if}
